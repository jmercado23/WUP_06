...
Looking in the graph above, black people seem to oppose capital punishment more than favor it. The other races like white favor the capital punishment more percentage wise. 
...
This table as shown above reaffirms the percentages, 68% of the white group are in favor while 49% in the black group and 68% of the other group. 50% of the black group and 31% of the white group oppose this. 
...
Though because we used more data, the fisher XY test was able to show us that the different test groups are different from each other. The white and black groups are different, as well as the white and other as well as the the groups other and black. 

# Discussion and Conclusion

The Fisher test here shows that the black and other group are very different. It also shows that the white and the black group are different. It does not show any more differences between the other and white groups. 
